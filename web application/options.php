...
<p> Do you need other resources? </p>
<a href="askfor.php?project_id=<?php echo $project_id;?>" class="btn btn-info" role="button">Yes</a>
<a href="reward.php?project_id=<?php echo $project_id;?>" class="btn btn-info" role="button">No</a>
</div></div>
